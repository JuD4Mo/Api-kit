...
To install the latest version directly using `go install`:

```bash
go install github.com/Jud4Mo/Api-kit/cmd/api-kit@latest
```

*(Note: Binaries can also be provided for Linux, macOS, and Windows via GitHub Releases in the future).*
